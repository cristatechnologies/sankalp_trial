...
import ThreeImageMenu from "./HomePageComponent/ThreeImageMenu";
import MarqueeComponent from "./MarqueeComponent";


export default function StorePageThemeEight({ homepageData }) {
 ...
 const boxData = [
   { bg: "red", content: "Chat Counter" },
   { bg: "cyan", content: "Deicious" },
   { bg: "blue", content: "Dashing Dosas" },
   { bg: "lime", content: "Crispy vada" },
 ];
  ...
  return (
    <>
      <Layout childrenClasses="pt-0 pb-[60px] font-bebas ">
        <Ads />
        {homepage && (
              ...
              <SliderProductCard
                categories={
                  homepage.featuredCategoryProducts.length > 0
                    ? homepage.featuredCategoryProducts.slice(0, 6)
                    : []
                }
