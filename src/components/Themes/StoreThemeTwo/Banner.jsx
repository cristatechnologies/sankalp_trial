                      ...
                      images.map((item, i) => (
                        <div key={i} className="item w-full h-full group">
                          <div
                            ...
                            className="flex items-center justify-end w-full max-w-full h-full relative"
                          >
                            <div className="pr-20 flex flex-col items-start">
                              <div className="md:w-[112px] w-[100px] shadow md:h-[25px] h-[18px] flex items-center justify-center bg-white rounded-full md:mb-[30px] mb-[15px]">
                                <span className="text-[var(--primary-text-color)] uppercase md:text-xs text-[10px] font-semibold">
                                  {item.badge}
                                </span>
                              </div>
                              <div className="md:mb-[30px] mb-[15px] ">
                                <p className="md:text-[50px] text-[20px]  text-[var(--primary-text-color)] md:mb-3">
                                  {item.title_one}
                                </p>
                                {item.title_two &&
                                  item.title_two.trim() !== "" && (
                                    <h1 className="md:text-[50px] text-[20px] md:w-[400px] md:leading-[66px] text-[var(--primary-text-color)] font-bold">
                                      {item.title_two}
                                    </h1>
                                  )}
                              </div>
