  ...
  return (
    <>
      {selected_theme !== "theme3" ? (
        ...
        <div className={`section-wrapper w-full ${className || ""}`}>
          <div className="container-x mx-auto">
            <div className=" section-title flex justify-between items-center mb-5 border-b border-gray-200 pb-5">
              <div>
                <h1 className="sm:text-xl text-lg font-600 text-[var(--text-color)] leading-none">
                  {categoryTitle}
                </h1>
              </div>
              <div className="view-more-btn">
